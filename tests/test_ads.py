...
class TestAdMatcher(unittest.TestCase):
    ...
    def test_match_reasons_generation(self):
        ...
        has_query_match = any("query semantic match" in reason or "keyword match" in reason for reason in matched_ad.matchReasons)
        
        # At least one type of reason should be present
        self.assertTrue(has_constraint_reason or has_ethical_reason or has_query_match,
