...
class TestIntentExtractor(unittest.TestCase):
    ...
    def test_goal_classification(self):
        ...
        self.assertIn(
            intent.declared.goal,
            [IntentGoal.COMPARISON, IntentGoal.FIND_INFORMATION],
        ...
        self.assertIn(
            intent.declared.goal,
            [IntentGoal.TROUBLESHOOTING, IntentGoal.FIND_INFORMATION],
        ...
        self.assertIn(
            intent.declared.goal,
            [IntentGoal.PURCHASE, IntentGoal.FIND_INFORMATION],
