...
class ABTestService:
    ...
    def create_test(self, name: str, campaign_id: int, description: str = "",
                   traffic_allocation: float = 1.0, min_sample_size: int = 1000,
                   confidence_level: float = 0.95, primary_metric: str = "ctr") -> ABTest:
        """
    ...
    def add_variant(self, test_id: int, name: str, ad_id: int,
                   traffic_weight: float = 0.5, is_control: bool = False) -> ABTestVariant:
        """
    ...
    def _calculate_p_value(self, control_successes: int, control_trials: int,
    ...
    def get_all_tests(self, campaign_id: Optional[int] = None, 
