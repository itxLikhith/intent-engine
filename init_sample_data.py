...
from database import db_manager, Advertiser, Campaign, AdGroup, Ad, CreativeAsset, AdMetric
...
def init_sample_data():
    ...
    try:
        ...
        advertiser = Advertiser(
            name="Sample Advertiser Inc.",
            contact_email="contact@sample-advertiser.com"
        )
        db.add(advertiser)
        db.commit()
