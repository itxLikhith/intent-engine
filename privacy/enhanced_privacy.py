...
class EnhancedPrivacyControls:
    ...
    def get_privacy_compliance_report(self) -> Dict[str, Any]:
        ...
        from database import Ad as DbAd, AdMetric as DbAdMetric, ClickTracking as DbClickTracking, ConversionTracking as DbConversionTracking
        ...
        expired_metrics = self.db.query(DbAdMetric).filter(
            DbAdMetric.expires_at < datetime.utcnow()
        ).count()
