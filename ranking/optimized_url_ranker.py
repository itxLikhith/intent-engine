...
class PrivacyDatabase:
    ...
    PRIVACY_FRIENDLY_DOMAINS = {
        ...
        # Search engines
        'duckduckgo.com', 'startpage.com', 'searx.space', 'qwant.com',
        # Browsers
        'firefox.com', 'mozilla.org', 'brave.com', 'torproject.org',
        # VPN/Security
        'mullvad.net', 'ivpn.net', 'protonvpn.com', 'nordvpn.com',
        # Privacy tools
        'privacytools.io', 'privacyguides.org', 'ssd.eff.org',
        # Open source platforms
        'github.com', 'gitlab.com', 'codeberg.org', 'sourcehut.org',
        # Knowledge bases
    ...
    BIG_TECH_DOMAINS = {
        # Google
        'google.com', 'google.co', 'youtube.com', 'gmail.com', 'android.com',
        'chrome.com', 'googleapis.com', 'googleusercontent.com',
        # Microsoft
        'microsoft.com', 'windows.com', 'office.com', 'outlook.com', 'hotmail.com',
        ...
        # Amazon
        'amazon.com', 'amazon.co', 'aws.amazon.com', 'alexa.com',
        # Twitter/X
    ...
    TRACKER_DOMAINS = {
        ...
        'doubleclick.net', 'googlesyndication.com', 'googleapis.com',
...
class URLAnalyzer:
    ...
    def _is_open_source(self, domain: str) -> bool:
        ...
        open_source_indicators = [
            'github.com', 'gitlab.com', 'codeberg.org', 'sourcehut.org',
            'apache.org', 'mozilla.org', 'gnu.org', 'linux.org',
    ...
    def _is_non_profit(self, domain: str) -> bool:
        ...
        non_profit_indicators = [
            '.org', 'wikipedia.org', 'wikimedia.org', 'eff.org',
            'mozilla.org', 'apache.org', 'gnu.org',
        ]
...
class URLRanker:
    ...
    def _filter_urls(self,
                     ...
                     exclude_big_tech: bool) -> List[URLResult]:
    ...
    async def _calculate_relevance_scores(self, 
        ...
        contents = [
            f"{result.title} {result.description} {result.domain}"
            for result in results
        ]
    ...
    def _apply_intent_boosts(self,
                            scores: Dict[str, float],
                            result: URLResult,
                            intent: UniversalIntent) -> Dict[str, float]:
