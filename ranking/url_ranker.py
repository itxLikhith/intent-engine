...
from core.schema import (
    UniversalIntent, DeclaredIntent, InferredIntent, 
    Constraint, ConstraintType, UseCase, EthicalDimension,
    TemporalHorizon, Recency, Frequency, SkillLevel
)
...
class PrivacyDatabase:
    ...
    PRIVACY_FRIENDLY_DOMAINS = {
        ...
        "protonmail.com": {"privacy_score": 0.95, "tracker_count": 0, "encryption": True, "type": "service", "open_source": True},
        "proton.me": {"privacy_score": 0.95, "tracker_count": 0, "encryption": True, "type": "service", "open_source": True},
        "tutanota.com": {"privacy_score": 0.95, "tracker_count": 0, "encryption": True, "type": "service", "open_source": True},
        "tuta.io": {"privacy_score": 0.95, "tracker_count": 0, "encryption": True, "type": "service", "open_source": True},
        
        # Privacy-focused search
        "duckduckgo.com": {"privacy_score": 0.9, "tracker_count": 0, "encryption": True, "type": "search", "open_source": False},
        "startpage.com": {"privacy_score": 0.85, "tracker_count": 1, "encryption": True, "type": "search", "open_source": False},
        "searx.org": {"privacy_score": 0.95, "tracker_count": 0, "encryption": True, "type": "search", "open_source": True},
        "searxng.org": {"privacy_score": 0.95, "tracker_count": 0, "encryption": True, "type": "search", "open_source": True},
        
        # Open source platforms
        "github.com": {"privacy_score": 0.8, "tracker_count": 1, "encryption": True, "type": "code", "open_source": True},
        "gitlab.com": {"privacy_score": 0.85, "tracker_count": 0, "encryption": True, "type": "code", "open_source": True},
        "sourceforge.net": {"privacy_score": 0.75, "tracker_count": 2, "encryption": True, "type": "code", "open_source": True},
        
        # Privacy-focused browsers
        "brave.com": {"privacy_score": 0.9, "tracker_count": 0, "encryption": True, "type": "software", "open_source": True},
        "mozilla.org": {"privacy_score": 0.85, "tracker_count": 1, "encryption": True, "type": "software", "open_source": True},
        
        # Wikipedia and educational
        "wikipedia.org": {"privacy_score": 0.9, "tracker_count": 0, "encryption": True, "type": "encyclopedia", "open_source": True, "non_profit": True},
        "wikimedia.org": {"privacy_score": 0.9, "tracker_count": 0, "encryption": True, "type": "encyclopedia", "open_source": True, "non_profit": True},
        
        # Privacy-focused VPNs and tools
        "mullvad.net": {"privacy_score": 0.95, "tracker_count": 0, "encryption": True, "type": "vpn", "open_source": True},
        "nordvpn.com": {"privacy_score": 0.8, "tracker_count": 1, "encryption": True, "type": "vpn", "open_source": False},
        
        # FOSS alternatives
        "fsf.org": {"privacy_score": 0.9, "tracker_count": 0, "encryption": True, "type": "organization", "open_source": True, "non_profit": True},
        "opensource.org": {"privacy_score": 0.9, "tracker_count": 0, "encryption": True, "type": "organization", "open_source": True, "non_profit": True},
    }
    ...
    BIG_TECH_DOMAINS = {
        "google.com", "googleusercontent.com", "googledrive.com",
        "facebook.com", "instagram.com", "whatsapp.com", "messenger.com",
        "microsoft.com", "outlook.com", "live.com", "onedrive.com",
            ...
            if contents:
                ...
                for idx, url_idx in enumerate(url_indices):
                    ...
                    if embedding is not None:
                        ...
                        urls[url_idx].relevance_score = self._calculate_keyword_relevance(
                            urls[url_idx], query
                        )
