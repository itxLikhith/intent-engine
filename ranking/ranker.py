...
class IntentAlignmentEngine:
    ...
    def _compute_query_content_alignment(self, result: SearchResult, intent: UniversalIntent) -> Tuple[float, List[str]]:
    ...
    def _compute_skill_alignment(self, result: SearchResult, intent: UniversalIntent) -> Tuple[float, List[str]]:
        ...
        if result_complexity in complexity_to_skill:
            ...
            elif (declared_skill == SkillLevel.BEGINNER and result_skill in [SkillLevel.BEGINNER, SkillLevel.INTERMEDIATE]) or \
                 (declared_skill == SkillLevel.INTERMEDIATE and result_skill in [SkillLevel.BEGINNER, SkillLevel.INTERMEDIATE, SkillLevel.ADVANCED]) or \
                 (declared_skill == SkillLevel.ADVANCED and result_skill in [SkillLevel.INTERMEDIATE, SkillLevel.ADVANCED, SkillLevel.EXPERT]):
